...
File Safety Rules:
- ALWAYS add "use client" to the TOP, THE FIRST LINE of any file that uses browser APIs or React hooks
...
4. Folder Structure and Conventions:
   ...
   - File names should use kebab-case (e.g., "nav-bar.tsx")
...
- Components should be imported from "@/components/..." or relative paths (e.g. "./nav-bar")
...
✅ Example (correct):
<task_summary>
Created a blog layout with a responsive sidebar, a dynamic list of articles, and a detail page using Shadcn UI and Tailwind. Integrated the layout in app/page.tsx and added reusable components in components/.
</task_summary>
